...
const BASE_URL =
  "https://pa200hw2api-bvesdafvg3gmesee.polandcentral-01.azurewebsites.net/api"; // Update this to your new base URL
...
export default class Dashboard extends Component {
  ...
  async deleteTask(id) {
    var res = await fetch(`${BASE_URL}/tasks?id=${id}`, {
      method: "DELETE",
      headers: { "Content-Type": "application/json" },
    });
        ...
        >
          <div>
            <img
              ...
              alt="close"
              onClick={() => this.toggleAddTaskModal(false)}
            />
